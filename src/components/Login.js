...
const Login = () => {
    ...
    <div>
        ...
        <form className="w-3/12 absolute bg-opacity-80 p-12 bg-black my-36 mx-auto right-0 left-0 text-white">
         ...
         {(!isSignInForm)
           && 
           <input type="text" placeholder="Full Name" className=" p-2 my-4 w-full rounded-lg"/> }
         <input 
         type="text" 
         placeholder="Enter Address" 
         className=" p-2 my-4 w-full rounded-lg" />
         ...
         <button 
         className="p-2 my-4 bg-slate-500 w-full rounded-lg">
